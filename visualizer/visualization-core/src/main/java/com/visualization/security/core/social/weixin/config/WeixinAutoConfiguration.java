package com.visualization.security.core.social.weixin.config;

import com.visualization.security.core.properties.SecurityProperties;
import com.visualization.security.core.properties.WeixinProperties;
import com.visualization.security.core.social.ConnectView;
import com.visualization.security.core.social.weixin.connect.WeixinConnectionFactory;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "visualization.security.social.weixin", name = "app-id")
